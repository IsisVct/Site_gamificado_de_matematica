...
$subject = isset($_GET['subject']) ? $_GET['subject'] : 'Geoplana';
...
<head>
    ...
    <title>Quiz de Geometria Plana</title>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Quiz de Geometria Plana</h1>
        <form id="quiz-form" method="post" action="submit_geoplana.php">
