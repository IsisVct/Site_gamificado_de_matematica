...
$subject = isset($_GET['subject']) ? $_GET['subject'] : 'graficos';
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Quiz de Gráficos</h1>
        <form id="quiz-form" method="post" action="submit_graficos.php">
