...
$subject = isset($_GET['subject']) ? $_GET['subject'] : 'estatistica';
...
<head>
    ...
    <title>Quiz de Estatisticas</title>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Quiz de Estatistícas</h1>
        <form id="quiz-form" method="post" action="submit_estatistica.php">
            ...
            <div class="text-center">
                ...
                <button type="button" class="btn btn-primary" id="next-btn">Próxima Questão</button>
                <button type="submit" class="btn btn-success" id="submit-btn" style="display: none;">Enviar Quiz</button>
            </div>
        </form>
    </div>
