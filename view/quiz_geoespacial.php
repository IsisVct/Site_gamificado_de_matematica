...
$subject = isset($_GET['subject']) ? $_GET['subject'] : 'geoespacial';
...
<head>
    ...
    <title>Quiz de Geometria Espacial</title>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Quiz de Geometria Espacial</h1>
        <form id="quiz-form" method="post" action="submit_geoespacial.php">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-secondary bc" id="prev-btn" style="display: none;">Questão Anterior</button>
