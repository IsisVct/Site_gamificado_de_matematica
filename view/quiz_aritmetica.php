...
$subject = isset($_GET['subject']) ? $_GET['subject'] : 'aritmetica';
...
<head>
    ...
    <title>Quiz de Aritmética</title>
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Quiz de Aritmética</h1>
        <form id="quiz-form" method="post" action="submit_aritmetica.php">
